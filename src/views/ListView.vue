...
export default {
  ...
  //   this.pageNationList = this.result.slice(this.pageNum, 10);
  //   // this.pageNationList.push(this.result.slice(0,9))
  //   console.log(this.pageNationList);
  // },
  components: { ListItem },
};
</script>
